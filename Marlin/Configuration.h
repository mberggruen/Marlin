...
#define STRING_CONFIG_H_AUTHOR "(MCB, Ender-5)" // Who made the changes.
 ...
 */
#define X_DRIVER_TYPE  TMC2209_STANDALONE //-MCB Revert to standalone, trying stealthchop enable w/i menu
